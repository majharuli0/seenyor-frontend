...
const PasswordInput = ({ label, label2, register, placeholder, error }) => {
  ...
  return (
    <div className='flex flex-col items-start w-full mt-5 relative'>
      ...
      {label2 && <label className='label mt-2'>{label2}</label>}
    </div>
  );
};
