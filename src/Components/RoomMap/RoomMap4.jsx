...
const DetectionBoundaryCanvas = ({ roomInfo = {}, playbackData = null }) => {
  const [positions, setPositions] = useState([]);
  const [peopleData, setPeopleData] = useState(null);
  const heartBreathRateRef = useRef(false); // Tracks the current state of heartBreathRateActive
  const timeoutRef = useRef(null); // Tracks the timeout for resetting heartBreathRateActive
