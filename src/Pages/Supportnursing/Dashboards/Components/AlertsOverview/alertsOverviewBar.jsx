...
import MultiLineChart from '../3xLineChart/MultiLineChart';
import { getAlertsOverviewGraph } from '@/api/elderlySupport';
import dayjs from 'dayjs';
import BarChart from '../BarChart';

export default function AlertsOverviewBar() {
  ...
  return (
    <div className='w-full h-full'>
      <div id='ChartHeader' className='w-full flex justify-between'>
        <h1 className='text-[18px] font-semibold'>Alarms Overview</h1>
      ...
      <div className='w-full h-full'>
        <BarChart data={overviewData} fromDate={fromDate} toDate={toDate} />
      </div>
    </div>
  );
}
