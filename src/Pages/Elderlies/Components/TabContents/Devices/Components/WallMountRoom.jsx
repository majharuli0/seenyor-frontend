...
const WallMount = ({ device_id, elderly_id }) => {
  ...
  const centerY = 0;
  const scale = 10;
  const canvasCenter = { x: 35 * scale, y: 0 };
  ...
  const handleAddObject = async (type) => {
    ...
    if (hasUnsavedChanges) {
      ...
      if (confirmation) {
        ...
        revertChanges(true); // Force cleanup
      }
    }
  ...
  const saveToAPI = async (obj) => {
    ...
    if (isNewObject) {
      console.log('temp obj trying to add');
      addRoomObject({
        ...
        <div className='border-b border-b-slate-200 p-2 py-4 '>
          ...
          >
            <div className='w-full flex items-center justify-between'>
              <div>
                <Alert
                  message='Click or drag to draw the area, click to edit the area, double-click to delete the area'
                  type='info'
                  showIcon
                />
              </div>
                    ...
                    <>
                      ...
                      <div className='flex flex-col items-center gap-2'>
                        ...
                        <p className='text-sm text-gray-500 mt-2'>
                          Adjust by 1 decimeters per click
                        </p>
                      </div>
                    </>
                  ),
