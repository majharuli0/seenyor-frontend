  ...
  return (
    <div className='flex w-full justify-end gap-4'>
      <div className='top-2 left-2 border-2 p-0 rounded-full flex items-center gap-1 pr-2 h-fit w-fit'>
        ...
        <span className='font-bold text-lg'>{peopleData ? peopleData?.length : 0}</span>
      </div>
            ...
            <>
              <div className='pr-1'>
                <FaBedPulse
                  size={20}
                  color={
                    decodeMinuteSleepStats(currentState)?.statusEvents?.sleepState?.color || 'gray'
                  }
                />
              </div>
